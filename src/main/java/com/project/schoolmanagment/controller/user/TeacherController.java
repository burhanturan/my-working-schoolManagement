...
public class TeacherController {
    ...
    public ResponseMessage<TeacherResponse> updateTeacherForManagers(
    ...
    @PreAuthorize("hasAnyAuthority('ADMIN','MANAGER','ASSISTANT_MANAGER')")
    public ResponseMessage<TeacherResponse> addLessonProgram(
            @RequestBody @Valid ChooseLessonTeacherRequest teacherRequest
            ){
    ...
    public List<UserResponse> getAllAdvisorTeachers(){
        return teacherService.getAllAdvisorTeachers();
    }
